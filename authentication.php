    ...
    " role="navigation">
      <div class="container">
        ...
        <div class="navbar-header">
          <a href="cpanel.php" class="navbar-brand headerFont text-lg"><strong>VOTING SYSTEM</strong></a>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-4 text-center" style="border:2px solid gray;padding:50px;">
          ...
          if (empty($_POST['adminUserName']) || empty($_POST['adminPassword'])) {
            ...
            $sql = "SELECT * FROM projectdb.tbl_admin WHERE admin_username='" . $admin_username . "' AND admin_password='" . $admin_password . "'";
