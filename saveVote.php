    ...
    " role="navigation">
      <div class="container">
        ...
        <div class="navbar-header">
          <a href="index.html" class="navbar-brand headerFont text-lg"><strong>VOTING SYSTEM</strong></a>
        </div>
    ...
    <div class="container" style="padding-top:150px;">
    	<div class="row">
          ...
          else
          {
            ...
            $sql= "INSERT INTO projectdb.tbl_users VALUES(null,'".$name."','".$email."','".$voterID."','".$selection."');";
